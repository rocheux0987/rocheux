...
function filter_search(){
	...
	document.location.href = "?act=list&pet_type="+document.getElementById("breed").value;
}
	...
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.pet_type eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Breed <input class="field-search enter-trigger-search" type="text" id="breed" name="breed" value="{$smarty.get.breed}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
