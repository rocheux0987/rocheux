...
function validate_form(){
	...
	//Breed
	if ($("#breed").val() == ""){
		$("#breed").addClass("field-error");
		$("#breed").focus();
		return false;
	}else{
		$("#breed").removeClass("field-error");
	}
         ...
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               <div class="control-group">
                    <label class="control-label" for="pet_types">Pet type</label>
                    <div class="controls">
                      <select id="pet_type" name="form_data[pet_type]">
               ...
               <div class="control-group">
                  ...
                  <div class="controls">
                     <input type="text" class="span6" id="breed" name="form_data[breed]">
                  </div>
               </div>
               <div class="control-group">
