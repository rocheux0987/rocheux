...
function filter_search(){
	...
	document.location.href = "?act=list&dislike="+document.getElementById("dislike").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.dislike eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Dislike <input class="field-search enter-trigger-search" type="text" id="dislike" name="dislike" value="{$smarty.get.dislike}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
