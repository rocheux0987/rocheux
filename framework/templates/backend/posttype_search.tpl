...
function filter_search(){
	if (document.getElementById("posttype").value == ""){
		notification("At least one field must be filled to continue", "error", true);
		return false;	
	}
	document.location.href = "?act=list&posttype="+document.getElementById("posttype").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.posttype eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Post Type <input class="field-search enter-trigger-search" type="text" id="posttype" name="posttype" value="{$smarty.get.posttype}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
