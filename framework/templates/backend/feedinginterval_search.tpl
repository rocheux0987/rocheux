...
function filter_search(){
	if (document.getElementById("feeding_interval").value == ""){
		notification("At least one field must be filled to continue", "error", true);
		return false;	
	}
	document.location.href = "?act=list&feeding_interval="+document.getElementById("feeding_interval").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.feedinginterval eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Feeding Interval <input class="field-search enter-trigger-search" type="text" id="feeding_interval" name="feeding_interval" value="{$smarty.get.feedinginterval}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
