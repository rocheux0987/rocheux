...
function validate_form(){
	...
	//Behavior
	if ($("#behavior").val() == ""){
		$("#behavior").addClass("field-error");
		$("#behavior").focus();
		return false;
	}else{
		$("#behavior").removeClass("field-error");
	}
      ...
      <div class="box-content">
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               ...
               <div class="control-group">
                  <label class="control-label" for="breed">behavior</label>
                  <div class="controls">
                     <input type="text" class="span6" id="behavior" name="form_data[behavior]">
                  </div>
               </div>
               <div class="control-group">
