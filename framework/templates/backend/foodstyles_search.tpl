...
function filter_search(){
	if (document.getElementById("foodstyle").value == ""){
		notification("At least one field must be filled to continue", "error", true);
		return false;	
	}
	document.location.href = "?act=list&foodstyle="+document.getElementById("foodstyle").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.foodstyle eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Food style <input class="field-search enter-trigger-search" type="text" id="foodstyle" name="foodstyle" value="{$smarty.get.foodstyle}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
