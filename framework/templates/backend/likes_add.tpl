...
function validate_form(){
	...
	//Like
	if ($("#like").val() == ""){
		$("#like").addClass("field-error");
		$("#like").focus();
		return false;
	}else{
		$("#like").removeClass("field-error");
	}
      ...
      <div class="box-content">
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               ...
               <div class="control-group">
                  <label class="control-label" for="breed">Like</label>
                  <div class="controls">
                     <input type="text" class="span6" id="like" name="form_data[like]">
                  </div>
               </div>
               <div class="control-group">
