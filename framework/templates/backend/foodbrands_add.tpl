...
function validate_form(){
	...
	//Food brand
	if ($("#foodbrand").val() == ""){
		$("#foodbrand").addClass("field-error");
		$("#foodbrand").focus();
		return false;
	}else{
		$("#foodbrand").removeClass("field-error");
	}
      ...
      <div class="box-content">
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               ...
               <div class="control-group">
                  <label class="control-label" for="breed">Food brand </label>
                  <div class="controls">
                     <input type="text" class="span6" id="foodbrand" name="form_data[foodbrand]">
                  </div>
               </div>
               <div class="control-group">
