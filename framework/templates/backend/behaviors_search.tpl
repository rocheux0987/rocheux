...
function filter_search(){
	...
	document.location.href = "?act=list&behavior="+document.getElementById("behavior").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.behavior eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Behavior <input class="field-search enter-trigger-search" type="text" id="behavior" name="behavior" value="{$smarty.get.behavior}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
