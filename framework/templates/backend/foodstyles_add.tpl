...
function validate_form(){
	...
	//Food style
	if ($("#foodstyle").val() == ""){
		$("#foodstyle").addClass("field-error");
		$("#foodstyle").focus();
		return false;
	}else{
		$("#foodstyle").removeClass("field-error");
	}
      ...
      <div class="box-content">
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               ...
               <div class="control-group">
                  <label class="control-label" for="breed">Food style </label>
                  <div class="controls">
                     <input type="text" class="span6" id="foodstyle" name="form_data[foodstyle]">
                  </div>
               </div>
               <div class="control-group">
