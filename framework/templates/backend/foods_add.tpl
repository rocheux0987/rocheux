...
function validate_form(){
	...
	//Food
	if ($("#food").val() == ""){
		$("#food").addClass("field-error");
		$("#food").focus();
		return false;
	}else{
		$("#food").removeClass("field-error");
	}
      ...
      <div class="box-content">
         <form class="form-horizontal" id="form-primary" method="POST">
            <fieldset>
               ...
               <div class="control-group">
                  <label class="control-label" for="breed">Food</label>
                  <div class="controls">
                     <input type="text" class="span6" id="food" name="form_data[food]">
                  </div>
               </div>
               <div class="control-group">
