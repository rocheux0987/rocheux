...
function filter_search(){
	...
	document.location.href = "?act=list&food="+document.getElementById("food").value;
}
...
<div class="row-fluid">
	<div class="box span12">
        ...
        <div class="box-content" {if $smarty.get.food eq ''}style="display:none"{/if}>
            <table class="table table-striped table-bordered">
              <thead>
                  <tr>
                      <th width="25%" ><label>Food <input class="field-search enter-trigger-search" type="text" id="food" name="food" value="{$smarty.get.food}" /></label> </th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                      <th width="25%"></th>
                  </tr>
