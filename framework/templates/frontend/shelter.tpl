...
<div class="mid">
	<div class="nearest-header whitebox">
		<div class="text-center">
			...
			<h3>Nearest Pet Foundation <br><small class="text-muted">Find your nearest Pet Foundation</small></h3>
			<div class="search-input-nearest">
				<form method="get" action="{'shelter.php'|seo_url}/" id="search_form">
